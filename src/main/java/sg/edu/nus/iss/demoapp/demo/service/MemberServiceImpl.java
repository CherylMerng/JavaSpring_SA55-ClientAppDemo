...
public class MemberServiceImpl implements MemberService, UserDetailsService {
    ...
    public Member findById(Long id) {
        Mono<Member> retrievedMember = webClient.get() // http request call
                .uri("/members/" + id)
                .accept(MediaType.APPLICATION_JSON)
        ...
        return retrievedMember.block(); // convert back to member object
        // need to convert so that your page can see data
    }
